...
const AboutUs = () => {
    return (
        <div className='xl:pt-[70px] lg:pt-20 xl:pb-[115px] lg:pb-24 md:py-16 py-6 relative' id='about'>
            ...
            <div className='container max-w-[1360px] mx-auto'>
                <div className="xl:flex-row justify-center xl:justify-between flex flex-col items-center w-full xl:gap-[83px] gap-10">
                    ...
                    <div className="xl:w-[576px] w-full max-sm:mt-10 max-xl:mt-20 flex xl:h-[650px] max-xl:justify-center">
