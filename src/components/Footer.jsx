...
const Footer = () => {
    return (
        <div data-aos="fade-up" className='relative max-w-[1920px] mx-auto'>
            <img className='absolute bottom-0 w-full left-0 -z-[1] xl:h-[650px] h-[290px] sm:h-[300px] md:h-[335px] lg:h-[500px]' src="/assets/images/png/cloud-img.png" alt="cloud-image" />
