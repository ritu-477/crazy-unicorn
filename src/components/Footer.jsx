...
const Footer = () => {
    return (
        <div data-aos="fade-up" className='relative max-w-[1920px] mx-auto'>
            ...
            <img className='absolute left-0 bottom-0 xl:max-w-[600px]  max-w-[150px] sm:max-w-[250px] lg:max-w-[300px] w-full pointer-events-none' src="/assets/images/png/footer-ellipse.png" alt="footer-ellipse" />
