...
const OurStory = () => {
  return (
      <div className='relative max-2xl:pt-20 max-lg:pt-16 max-md:pt-14 max-sm:pt-12 xl:pb-[106px] lg:pb-20 md:pb-16 pb-12'>
