...
const OurStory = () => {
  return (
    <div data-aos="fade-up" className='relative max-2xl:pt-20 max-lg:pt-16 max-md:pt-14 max-sm:pt-16 xl:pb-[106px] lg:pb-[70px] md:pb-16 pb-6 pt-3 max-w-[1920px] mx-auto' id='story'>
