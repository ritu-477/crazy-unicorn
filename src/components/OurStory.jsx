...
const OurStory = () => {
  return (
    <div data-aos="fade-up" className='relative max-2xl:pt-20 max-lg:pt-16 max-md:pt-14 max-sm:pt-16 xl:pb-[106px] lg:pb-[70px] md:pb-16 pb-6 pt-24' id='story'>
          <div className='absolute left-0 2xl:top-[-270px] top-0 -z-10 xl:block hidden'><img className='2xl:max-w-[370px] xl:max-w-[200px] max-w-[100px] pointer-events-none' src="/assets/images/png/our-story-left-ellipse.png" alt="left-ellipse" /></div>
