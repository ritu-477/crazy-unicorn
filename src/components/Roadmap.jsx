...
const Roadmap = () => {
  return (
    <div className='relative xl:pt-[90px] lg:pb-[66px] lg:pt-24 md:py-16 sm:py-14 pt-12 pb-6 max-w-[1920px] mx-auto' id='roadmap'>
      ...
      <img className='absolute left-0 top-[-20%] 2xl:max-w-[370px] xl:max-w-[200px] lg:max-w-[150px] max-w-[100px] w-full pointer-events-none star-animation lg:block hidden' src="/assets/images/png/our-story-left-ellipse.png" alt="left-ellipse" />
      <img className='absolute left-0 bottom-0 2xl:max-w-[370px] xl:max-w-[200px] lg:max-w-[150px] max-w-[100px] w-full pointer-events-none star-animation lg:block hidden' src="/assets/images/png/our-story-left-ellipse.png" alt="left-ellipse" />
      <div className='container max-w-[1362px] mx-auto'>
        ...
        <div className='relative flex'>
          ...
          <div>
            <div data-aos="fade-right" className='sm:max-w-[541px] 2xl:w-1/2 xl:w-[31%] lg:w-[50%] md:w-[37%] sm:w-[36%] w-full left-0 sm:absolute xl:pt-[144px] lg:pt-24 sm:pt-16 pt-2 top-0 max-sm:pl-12 max-sm:pb-6 timeline-content'>
            ...
            <div data-aos="fade-left" className='sm:max-w-[451px] 2xl:w-1/2 xl:w-[31%] lg:w-[50%] md:w-[37%] sm:w-[36%] w-full sm:absolute sm:right-0 top-[20%] sm:pb-[50px] max-sm:pl-12 lg:pl-24 xl:pl-0 max-sm:pb-6 timeline-content'>
              ...
              <p className='font-comic-neue font-normal lg:text-custom-2xl md:text-sm text-xs sm:leading-5 md:leading-6 lg:leading-custom-5xl 2xl:max-w-[453px] sm:max-w-[425px]'>Sed lectus ut elit id lectus diam massa nisl pretium. Sagittis, adipiscing maecenas lorem ullamcorper. Faucibus netus sed varius loborti orbi sit sit magna lorem arcu.</p>
            </div>
            <div data-aos="fade-right" className='sm:max-w-[451px] 2xl:w-1/2 xl:w-[31%] lg:w-[50%] md:w-[37%] sm:w-[36%] w-full left-0 sm:absolute top-[33%] left max-sm:pl-12 max-sm:pb-6 timeline-content'>
              ...
              <p className='font-comic-neue font-normal lg:text-custom-2xl md:text-sm text-xs sm:leading-5 md:leading-6 lg:leading-custom-5xl sm:max-w-[411px]'>Sed lectus ut elit id lectus diam massa nisl pretium. Sagittis, adipiscing maecenas lorem ullamcorper. Faucibus netus sed varius loborti orbi sit sit magna lorem arcu.</p>
            </div>
            <div data-aos="fade-left" className='sm:max-w-[485px] 2xl:w-1/2 xl:w-[31%] lg:w-[50%] md:w-[37%] sm:w-[36%] w-full sm:absolute sm:right-0 xl:top-[45%] sm:top-[47%] top-[55%] lg:pl-24 xl:pl-4 2xl:pl-14 max-sm:pl-12 max-sm:pb-6 timeline-content'>
              ...
              <p className='font-comic-neue font-normal lg:text-custom-2xl md:text-sm text-xs sm:leading-5 md:leading-6 lg:leading-custom-5xl sm:max-w-[465px]'>Sed lectus ut elit id lectus diam massa nisl pretium. Sagittis, adipiscing maecenas lorem ullamcorper. Faucibus netus sed varius loborti orbi sit sit magna lorem arcu.</p>
            </div>
            <div data-aos="fade-right" className='sm:max-w-[451px] 2xl:w-1/2 xl:w-[31%] lg:w-[50%] md:w-[37%] sm:w-[36%] w-full left-0 sm:absolute 2xl:bottom-[33%] sm:bottom-[21%] bottom-[6%] max-sm:pl-12 max-sm:pb-6 timeline-content'>
              ...
              <p className='font-comic-neue font-normal lg:text-custom-2xl md:text-sm text-xs sm:leading-5 md:leading-6 lg:leading-custom-5xl sm:max-w-[411px] xl:pr-0 pr-5'>Sed lectus ut elit id lectus diam massa nisl pretium. Sagittis, adipiscing maecenas lorem ullamcorper. Faucibus netus sed varius loborti orbi sit sit.</p>
            </div>
         </div>
        </div>
      </div>
